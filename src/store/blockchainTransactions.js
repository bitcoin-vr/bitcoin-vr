...
export function loadTransactionsIntoState() {
  return function thunk(dispatch) {
    ...
    blockchainWS.onmessage = (msg) => {
      ...
      // let amount = op.x.out[0].value/100000000
      // // console.log(msg.data)
      // console.log("Blockchain.info: ", amount)
...
export default function (state = initialState, action) {
  switch (action.type) {
    case ADD_NEW_TRANSACTION: {
      ...
      // Gets the current exchange rate as the transactions Websocket does not include it
      ...
      .then((exchangeMsg) => {
        ...
        // As Blockchain.info's UTX websocket does not have the exchange price, this is the best approximation we can find
        const exchangeRate = exchangeMsg.USD.last
        ...
        transactionUSD = +(exchangeRate*transactionSize).toFixed(2);
